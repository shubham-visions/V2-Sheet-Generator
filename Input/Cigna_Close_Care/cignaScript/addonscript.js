let codes = [
  ...
  const files = [
    "/home/support/Desktop/saleslabb/V2-Sheet-Generator-Forked/Input/Cigna_Close_Care/cignaScript/inputRates/addon.xlsx"
  ]
  ...
  files.forEach((path, p) => {
    ...
    codes.forEach((codeName, i) => {
        ...
        xlsx.writeFile(wb, `/home/support/Desktop/saleslabb/V2-Sheet-Generator-Forked/Input/Cigna_Close_Care/cignaScript/output/addons/addon${i}.xlsx`);
    })
