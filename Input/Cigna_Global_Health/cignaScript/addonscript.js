let codes = [
  ...
  const files = [
    "C:/Users/shubh/OneDrive/Desktop/cignaScript/inputRates/addon.xlsx"
  ]
  ...
  files.forEach((path, p) => {
    ...
    codes.forEach((codeName, i) => {
        ...
        xlsx.writeFile(wb, `C:/Users/shubh/OneDrive/Desktop/cignaScript/output/addons/addon${i}.xlsx`);
    })
